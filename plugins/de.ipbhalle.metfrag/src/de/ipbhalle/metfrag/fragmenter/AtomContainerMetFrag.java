 ...
 * @cdk.svnrev  $Revision$
 *
 * @author steinbeck, swolf
 * @cdk.created 2000-10-02
 */
public class AtomContainerMetFrag extends ChemObject 
  implements IAtomContainer, Serializable, Cloneable {
	 ...
	 *  Constructs an empty AtomContainer.
	 */
	public AtomContainerMetFrag(double bondEnergy) {
        this(10, 10, 0, 0);
	 ...
	 */
	public AtomContainerMetFrag(IAtomContainer container)
	{
	 ...
	 *
	 */
	public AtomContainerMetFrag(int atomCount, int bondCount, int lpCount, int seCount)
	{
		this.atomCount = 0;
		this.bondCount = 0;
